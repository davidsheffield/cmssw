...
class ScoutingPhoton
{
    public:
        ...
        ScoutingPhoton(float pt, float eta, float phi, float m, float dEtaIn, float dPhiIn,
		       float sigmaIetaIeta, float hOverE, float ooEMOop, int missingHits,
		       int charge, float ecalIso, float hcalIso):
            pt_(pt), eta_(eta), phi_(phi), m_(m), dEtaIn_(dEtaIn), dPhiIn_(dPhiIn),
        ...
        //default constructor
        ScoutingPhoton(): pt_(0), eta_(0), phi_(0), m_(0), dEtaIn_(0), dPhiIn_(0),
