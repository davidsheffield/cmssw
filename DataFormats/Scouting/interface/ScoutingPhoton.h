...
class ScoutingPhoton
{
    public:
        ...
        ScoutingPhoton(float pt, float eta, float phi, float m, float d0, float dZ, float dEtaIn,
	    ...
	    trackIso_(trackIso) {}
        //default constructor
        ScoutingPhoton(): pt_(0), eta_(0), phi_(0), m_(0), d0_(0), dZ_(0), dEtaIn_(0), dPhiIn_(0),
