#ifndef DataFormats_HLTScoutingMuon_h
#define DataFormats_HLTScoutingMuon_h

#include <vector>

//class for holding muon information, for use in data scouting 
//IMPORTANT: the content of this class should be changed only in backwards compatible ways!
class HLTScoutingMuon
{
    public:
        //constructor with values for all data fields
        HLTScoutingMuon(float pt, float eta, float phi, float m,
            ...
            nMatchedStations_(nMatchedStations), nTrackerLayersWithMeasurement_(nTrackerLayersWithMeasurement) {}
        //default constructor
        HLTScoutingMuon():pt_(0), eta_(0), phi_(0), m_(0), 
    ecalIso_(0), hcalIso_(0), trackIso_(0), 
    chi2_(0), ndof_(0), charge_(0), dxy_(0), dz_(0),
    nValidMuonHits_(0), nValidPixelHits_(0),
    nMatchedStations_(0), nTrackerLayersWithMeasurement_(0) {}
...
typedef std::vector<HLTScoutingMuon> HLTScoutingMuonCollection;
